...
2. **Check Metrics**: the right panel heading is **Metrics**. Labels are Floors, Agents, Tasks, Tools. Default **Tasks** count is 0 — `task-001` is constructed and never registered.
