...
class TestAPIEndpoints:
    ...
    def test_consigliere_explain_why_decision(self, client):
        ...
        response = client.post(
            "/api/consigliere/explain",
            data=json.dumps({"type": "why_decision", "entity_id": "test-entity"}),
            content_type="application/json",
        )
        assert response.status_code == 200
    ...
    def test_consigliere_translate(self, client):
        ...
        response = client.post(
            ...
            data=json.dumps({"text": "some civilizational text"}),
            content_type="application/json",
        )
        assert response.status_code == 200
    ...
    def test_consigliere_preview(self, client):
        ...
        response = client.post(
            ...
            data=json.dumps({"action": "refactor codebase", "context": {}}),
            content_type="application/json",
        )
        assert response.status_code == 200
    ...
    def test_consigliere_draft_missing_params(self, client):
        ...
        response = client.post(
            "/api/consigliere/draft",
            data=json.dumps({"goal": "implement authentication"}),
            content_type="application/json",
        )
        assert response.status_code == 400
    ...
    def test_consigliere_command_manager_missing_params(self, client):
        ...
        response = client.post(
            "/api/consigliere/command/manager",
            data=json.dumps({"manager_id": "mgr-001"}),
            content_type="application/json",
        )
        assert response.status_code == 400
    ...
    def test_consigliere_coordinate_missing_params(self, client):
        ...
        response = client.post(
            "/api/consigliere/coordinate",
            data=json.dumps({"floor_ids": ["floor-python"]}),
            content_type="application/json",
        )
        assert response.status_code == 400
    ...
    def test_consigliere_assess_feasible(self, client):
        ...
        response = client.post(
            ...
            data=json.dumps({"request": "implement new feature", "context": {}}),
            content_type="application/json",
        )
        assert response.status_code == 200
    ...
    def test_consigliere_assess_impossible(self, client):
        ...
        response = client.post(
            "/api/consigliere/assess",
            data=json.dumps({"request": "this is impossible to do", "context": {}}),
            content_type="application/json",
        )
        assert response.status_code == 200
    ...
    def test_security_audit_full_system(self, client):
        ...
        response = client.post(
            "/api/security/audit",
            data=json.dumps({"type": "full_system", "reason": "periodic review"}),
            content_type="application/json",
        )
        assert response.status_code == 200
