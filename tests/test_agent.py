...
class TestAgent:
    ...
    def test_assign_task_success(self):
        ...
        task = Task(task_id="task1", name="Build feature", description="Test task")
    ...
    def test_assign_task_insufficient_capabilities(self):
        ...
        task = Task(task_id="task2", name="Rust task", description="Requires rust")
    ...
    def test_complete_task(self):
        ...
        agent = Agent(agent_id="agent5", name="Worker", role=AgentRole.BUILDER)

        task = Task(task_id="task3", name="Task", description="Test")
    ...
    def test_complete_task_no_current_task(self):
        ...
        agent = Agent(agent_id="agent6", name="Idle Agent", role=AgentRole.BUILDER)
    ...
    def test_perform_action(self):
        ...
        agent = Agent(agent_id="agent7", name="Actor", role=AgentRole.ARCHITECT)
    ...
    def test_perform_action_no_target_or_data(self):
        ...
        agent = Agent(agent_id="agent8", name="Minimalist", role=AgentRole.BUILDER)
...
class TestManager:
    ...
    def test_manager_creation(self):
        ...
        manager = Manager(manager_id="mgr1", name="Manager One", department_id="dept1")
    ...
    def test_add_managed_agent(self):
        ...
        manager = Manager(manager_id="mgr2", name="Manager Two")

        agent = Agent(agent_id="agent9", name="Subordinate", role=AgentRole.BUILDER)
...
class TestConsensusVote:
    ...
    def test_vote_creation(self):
        ...
        vote = ConsensusVote(agent_id="agent10", vote=True)
...
class TestConsensusDecision:
    ...
    def test_decision_creation(self):
        ...
        decision = ConsensusDecision(subject="Feature approval", target_id="feature1")
    ...
    def test_add_vote(self):
        ...
        decision = ConsensusDecision(subject="Test", target_id="target1")
    ...
    def test_calculate_outcome_no_votes(self):
        ...
        decision = ConsensusDecision(subject="No votes", target_id="target4")
    ...
    def test_issue_override(self):
        ...
        decision = ConsensusDecision(subject="Override test", target_id="target6")
    ...
    def test_to_dict(self):
        ...
        decision = ConsensusDecision(subject="Dict test", target_id="target7")
