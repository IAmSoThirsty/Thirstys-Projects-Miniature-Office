...
class TestFloorSchema:
    ...
    def test_schema_to_dict(self):
        """Test schema serialization."""
        schema = FloorSchema(floorId="floor-001", language="Python", offices=[])
        data = schema.to_dict()
    ...
    def test_schema_from_dict(self):
        """Test schema deserialization."""
        data = {"floorId": "floor-001", "language": "Python", "offices": []}
...
class TestWorld:
    ...
    def test_from_schema_with_floors(self):
        ...
        schema = WorldSchema(
            worldId="world-001",
            name="Test World",
            floors=[{"floorId": "floor-001", "language": "Python", "offices": []}],
            supplyStore={},
            time=0,
        )
        world = World.from_schema(schema)
