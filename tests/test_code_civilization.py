...
''',
    ...
    def test_reject_empty_code(self):
        ...
        impl = ImplementationOutput(code="", files_modified=["empty.py"])
...
class TestDataclassSerialization:
    ...
    def test_implementation_output_to_dict(self):
        ...
        impl = ImplementationOutput(code="def test(): pass", files_modified=["test.py"])
        data = impl.to_dict()
...
''',
    ...
    def test_review_detects_high_complexity(self):
        ...
        impl = ImplementationOutput(code=complex_code, files_modified=["complex.py"])
