...
class TestDepartment:
    ...
    def test_department_creation_no_toolchain(self):
        ...
        dept = Department(department_id="dept2", name="Rust Department", domain="Rust")
    ...
    def test_get_missing_roles_all_missing(self):
        ...
        dept = Department(department_id="dept5", name="Empty Dept", domain="Go")
    ...
    def test_get_missing_roles_partially_filled(self):
        ...
        dept = Department(department_id="dept6", name="Partial Dept", domain="Python")

        builder = Agent(agent_id="agent4", name="Builder", role=AgentRole.BUILDER)
        architect = Agent(agent_id="agent5", name="Architect", role=AgentRole.ARCHITECT)
    ...
    def test_default_capabilities_for_architect(self):
        ...
        dept = Department(department_id="dept8", name="Test Dept", domain="Python")
    ...
    def test_default_capabilities_for_builder(self):
        ...
        dept = Department(department_id="dept9", name="Test Dept", domain="Rust")
    ...
    def test_default_capabilities_for_verifier(self):
        ...
        dept = Department(department_id="dept10", name="Test Dept", domain="JavaScript")
    ...
    def test_default_capabilities_for_security(self):
        ...
        dept = Department(department_id="dept11", name="Test Dept", domain="Go")
    ...
    def test_default_capabilities_for_doc_agent(self):
        ...
        dept = Department(department_id="dept12", name="Test Dept", domain="TypeScript")
    ...
    def test_add_tool_to_toolchain_new(self):
        ...
        dept = Department(department_id="dept13", name="Tool Dept", domain="Python")

        # Create a mock tool entity
        from src.core.entity import Entity

        tool = Entity(entity_id="tool1", entity_type=EntityType.TOOL, name="Test Tool")
    ...
    def test_add_tool_to_toolchain_not_in_registry(self):
        ...
        dept = Department(department_id="dept15", name="Tool Dept", domain="Python")
    ...
    def test_has_role_filled_true(self):
        ...
        dept = Department(department_id="dept16", name="Filled Dept", domain="Python")

        agent = Agent(agent_id="agent7", name="Verifier", role=AgentRole.VERIFIER)
        dept.add_agent(agent)
    ...
    def test_has_role_filled_false(self):
        ...
        dept = Department(department_id="dept17", name="Empty Dept", domain="Python")
    ...
    def test_is_fully_staffed_false(self):
        ...
        dept = Department(department_id="dept19", name="Partial Dept", domain="Python")

        agent = Agent(agent_id="agent8", name="Only Builder", role=AgentRole.BUILDER)
        dept.add_agent(agent)
    ...
    def test_implement_contract(self):
        ...
        dept = Department(department_id="dept22", name="Contract Dept", domain="Python")
    ...
    def test_implement_contract_duplicate(self):
        ...
        dept = Department(department_id="dept23", name="Contract Dept", domain="Python")
    ...
    def test_implement_contract_not_in_registry(self):
        ...
        dept = Department(department_id="dept24", name="Contract Dept", domain="Python")
...
class TestDepartmentRegistry:
    ...
    def test_get_department_exists(self):
        ...
        dept = Department(department_id="dept26", name="Get Dept", domain="Rust")
        registry.register_department(dept)
    ...
    def test_get_departments_by_domain_case_insensitive(self):
        ...
        dept = Department(department_id="dept30", name="JS Dept", domain="JavaScript")
        registry.register_department(dept)
    ...
    def test_ensure_all_staffed(self):
        ...
        dept1 = Department(department_id="dept31", name="Partial Dept", domain="Python")
        builder = Agent(agent_id="agent12", name="Builder", role=AgentRole.BUILDER)
        dept1.add_agent(builder)

        # Create empty department
        dept2 = Department(department_id="dept32", name="Empty Dept", domain="Go")
