...
class TestResourceAllocation:
    ...
    def test_has_capacity(self):
        ...
        alloc = ResourceAllocation(agent_time=100, manager_attention=10, tool_slots=5)
    ...
    def test_consume_resource(self):
        ...
        alloc = ResourceAllocation(agent_time=100, manager_attention=10)
    ...
    def test_allocation_to_dict(self):
        """Test serialization"""
        alloc = ResourceAllocation(agent_time=50, tool_slots=3)
