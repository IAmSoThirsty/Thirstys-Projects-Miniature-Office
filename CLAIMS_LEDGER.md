...
**Independent remeasure (9 September 2026 11:20 UTC):** observed main `de549fc` after squash-merge of PR [#38](https://github.com/IAmSoThirsty/Thirstys-Projects-Miniature-Office/pull/38) (docs-only). Independent pytest on parent `4e1eff8` (identical `src/`/`tests/` to `de549fc` and to code pin `fdd9762`): **1,573 passed**, 1 skipped, **12.26s**. Coverage XML **7,493 / 7,749** (96.70%); pin remains **7,494 / 7,749** (96.71%). Bandit `-ll` 0 medium/high (13 low). `pip-audit` clean. CI [34345046652](https://github.com/IAmSoThirsty/Thirstys-Projects-Miniature-Office/actions/runs/34345046652) / CD [34345046769](https://github.com/IAmSoThirsty/Thirstys-Projects-Miniature-Office/actions/runs/34345046769) green on `de549fc`. Operator how-to: `DEMO.txt` / `QUICK_REFERENCE.md` no longer deny the PWA shell or invent a compose `SECRET_KEY` default. Pin stays `fdd9762`. Score stays **9/6/1/3 of 19**. Production ready remains false.
