...
| File | Role |
| --- | --- |
| [INSTALL.md](INSTALL.md) | Install and run. Browser app on port 5000. Not a VR product. |
...
| [PLATFORM_SUPPORT.md](PLATFORM_SUPPORT.md) | What “runs everywhere” means |
| [EASY_ACCESS.md](EASY_ACCESS.md) | LAN browser access |
| [DEPLOYMENT.md](DEPLOYMENT.md) | Docker / compose notes |
...
| File | Role |
| --- | --- |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Intended architecture |

## Historical / superseded

Agent-generated `*_COMPLETE.md`, `MAXIMUM_ALLOWED_*.md`, coverage certificates, and similar files remain so git history is intact. Each opens with a superseded banner. **Do not cite them.**

If a number in those files disagrees with [CLAIMS_AUDIT.md](CLAIMS_AUDIT.md), the audit wins.
